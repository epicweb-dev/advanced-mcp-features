...
<EpicVideo url="https://www.epicai.pro/workshops/advanced-mcp-features-flccv/structured-output~egacc" />
...
<callout-muted>
	...
	MCP
	documentation](https://modelcontextprotocol.io/specification/2025-11-25/server/tools#structured-content).
</callout-muted>
