...
📜 Please check [the table in the MCP docs](https://modelcontextprotocol.io/legacy/concepts/tools#available-tool-annotations) for the default values and when each annotation is useful.
