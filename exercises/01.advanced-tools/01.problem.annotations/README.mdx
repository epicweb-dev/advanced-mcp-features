...
📜 Please check [the MCP docs](https://modelcontextprotocol.io/specification/2025-11-25/schema#toolannotations) for the default values and when each annotation is useful.
