...
<EpicVideo url="https://www.epicai.pro/workshops/advanced-mcp-features-flccv/list-changed~43sfe" />
...
📜 For more details, see the [Server Spec: Prompts](https://modelcontextprotocol.io/specification/2025-11-25/server/prompts).
