...
<EpicVideo url="https://www.epicai.pro/workshops/advanced-mcp-features-flccv/subscriptions~hja2q" />
...
📜 For more details on `setRequestHandler` and subscriptions, see the [official MCP Server Spec: Resources](https://modelcontextprotocol.io/specification/2025-11-25/server/resources).
