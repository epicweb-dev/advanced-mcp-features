...
<EpicVideo url="https://www.epicai.pro/workshops/advanced-mcp-features-flccv/resource-template-list-changed~lkds0" />
...
📜 For more details, see the [Server Spec: Resources](https://modelcontextprotocol.io/specification/2025-11-25/server/resources).
